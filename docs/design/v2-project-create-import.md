...
Design for the v2 "create project" and "import project" flows. V2 projects are cloud-driven, and materialization is per-host. Companion: [`v2-host-project-paths.md`](./v2-host-project-paths.md) — path mapping + throw-on-create mechanics for workspaces.
...
| `v2WorkspaceLocalState` | Workspace is in sidebar iff row exists. Holds `sidebarState.projectId/tabOrder/sectionId`. |
