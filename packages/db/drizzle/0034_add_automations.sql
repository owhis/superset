...
CREATE TYPE "public"."automation_workspace_mode" AS ENUM('new_per_run', 'existing');--> statement-breakpoint
...
CREATE TABLE "automations" (
	...
	CONSTRAINT "automations_workspace_mode_invariant" CHECK ((
				("automations"."workspace_mode" = 'new_per_run' AND "automations"."v2_project_id" IS NOT NULL) OR
				("automations"."workspace_mode" = 'existing' AND "automations"."v2_workspace_id" IS NOT NULL)
			))
);
--> statement-breakpoint
...
ALTER TABLE "automation_runs" ADD CONSTRAINT "automation_runs_v2_workspace_id_v2_workspaces_id_fk" FOREIGN KEY ("v2_workspace_id") REFERENCES "public"."v2_workspaces"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "automations" ADD CONSTRAINT "automations_v2_workspace_id_v2_workspaces_id_fk" FOREIGN KEY ("v2_workspace_id") REFERENCES "public"."v2_workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
