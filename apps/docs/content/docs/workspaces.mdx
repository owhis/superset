...
Drag workspaces in the sidebar to reorder them. You can also drag between sections:

- **Drag a workspace** below a section header to add it to that section
- **Drag a workspace** above all sections to make it ungrouped
- **Drag a section** via its grip icon to reorder sections (workspaces collapse during section drag)
- **Drag a project** to reorder projects
