---
title: The v2 workspace, brand refresh, and a standalone Superset CLI
date: 2026-04-20
image: /changelog/IMAGE_PLACEHOLDER.png
---

{/* TODO: Replace header image with a screenshot of the new v2 workspace (panes + diff viewer + brand) */}

A big update covering the last three weeks: the v2 workspace is now fully featured with panes, a diff viewer, a file editor, a review tab, and a browser pane. The Superset CLI shipped and then grew a self-contained tarball that can run the host-service anywhere. The desktop app got a full brand refresh, and GitHub integration is now free on every plan.

## The v2 workspace is ready

The v2 workspace landed piece by piece over the last three weeks. Here's the full picture:
...
{/* TODO: Screenshot of the v2 diff viewer */}
...
{/* TODO: Screenshot of v2 file editor */}

A full-fledged editor pane in v2 workspaces — foundation, views, and a large stability pass so editing behaves like you'd expect in a native IDE.
...
{/* TODO: Screenshot of new brand — dock icon + wordmark */}
