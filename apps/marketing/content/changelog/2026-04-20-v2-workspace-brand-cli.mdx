---
title: Chat UX overhaul, the v2 workspace, a brand refresh, and a standalone CLI
date: 2026-04-20
image: /changelog/IMAGE_PLACEHOLDER.png
---

{/* TODO: Replace header image with a screenshot of the new v2 workspace (panes + diff viewer + chat + brand) */}
...
{/* TODO: Screenshot — Tiptap prompt input with a /command chip and an @file chip, plus a redesigned tool-call row */}
